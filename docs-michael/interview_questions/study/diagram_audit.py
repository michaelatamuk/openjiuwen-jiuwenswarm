...
Writes study/diagram_audit.csv and prints a summary + the questions that still
...
CONTENT = os.path.join(HERE, "android-app-2026", "app", "src", "main", "assets", "content.json")
...
def main():
    ...
    with open(os.path.join(HERE, "diagram_audit.csv"), "w", encoding="utf-8", newline="") as fh:
