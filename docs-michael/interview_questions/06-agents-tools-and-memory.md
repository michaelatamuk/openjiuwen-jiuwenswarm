...
## 2. Designing retry logic that doesn't cause duplicate side effects on a tool call
...
<sub>_Canonical source: `orig/ai-engineer-technical-questions_for_engineers.md`; also covered in: ai-agent, engineering._</sub>

## 3. Handling concurrent API calls when an agent needs to call multiple tools at once
...
## 4. How do you debug a failure when it's unclear which agent in the chain caused it
...
## 5. How do you decide between LangGraph, CrewAI, and the Anthropic Agent SDK for a given project
...
## 6. How do you decide how many retrieval hops are enough, and how do you prevent the system from looping indefinitely
...
## 7. How do you decide what to store in memory versus what to discard
...
## 12. How do you prevent multiple agents from producing conflicting or redundant results
...
## 13. How do you set a hard limit on iterations or steps within a framework
...
## 14. How do you version and roll back an agent's workflow definition, not just its prompts
...
## 15. How does a framework handle communication between multiple agents
...
## 16. How does a framework register and expose tools to the underlying model
...
## 17. How does a framework track state across multiple steps in an agent's execution
...
## 20. How does function calling actually work under the hood
...
## 21. How does the framework decide which node or agent runs next
...
## 22. How does the framework handle a step that times out or throws an error
...
## 23. How does the framework handle one agent's output becoming another agent's input
...
## 24. How would you add a custom retry policy for a specific tool without breaking the framework's default behavior
...
## 25. How would you add human-in-the-loop approval before a specific step executes
...
## 26. How would you pause an agent mid-execution and resume it later with the same state
...
## 27. How would you prevent an agentic RAG system from retrieving in an unnecessary loop and burning cost
