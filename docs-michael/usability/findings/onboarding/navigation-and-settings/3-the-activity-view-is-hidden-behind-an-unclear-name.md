...
Rename to "Agent activity" (or "What happened") and surface it as a default sub-tab in the right panel. Related: [Agent reasoning is hidden in a separate panel](../../conversation/explanation/1-agent-reasoning-is-hidden-in-a-separate-panel.md).
