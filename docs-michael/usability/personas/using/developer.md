...
A Developer is also a Web User (and, when self-hosting, often the Instance Admin). This persona highlights the findings that bite hardest when the work is code: reviewing and undoing file changes, seeing and stopping what the agent did, and getting actionable errors.
